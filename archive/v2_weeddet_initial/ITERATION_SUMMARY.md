...
**Status:** Superseded (contained critical Bug 1 in early runs).  
...
## Drive Files
- `weeddet_training_fixed.ipynb` (Drive ID: 1fp_154i5ifOGxKps-CRkcpCi4HQjLgPB)
- `Weed_Det_Training_v2.ipynb` (Drive ID: 1dswZo1d6rhF8wd_kRN-00DVwZXY93Lhm)
- `weeddet_checkpoints/` (Drive ID: 1MmcPXlO1wt7Y6HTvGfs5o3ag4A-pIf6F) — early checkpoints
- `weeddet_v2_checkpoints/` (Drive ID: 1yRIIemlDkhSAsAM0KKAz_2_SoiVjy3RH) — later checkpoints

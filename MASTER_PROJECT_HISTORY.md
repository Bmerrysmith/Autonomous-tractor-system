...
**Author:** Benjamin Merryman-Smith<br>
**Project:** AgriNav — Autonomous Paddy Field Tractor, Weed Detection Subsystem<br>
**Course:** CEN 4930, FGCU Whitaker College of Engineering, Spring 2026<br>
**Document generated:** 2026-06-01<br>
...
- Historical Colab authentication failures occurred; use current GitHub-supported, least-privilege,
  short-lived authentication and never store credentials in notebooks or repository files
...
| GitHub authentication rejected | Colab | Use current GitHub-supported, least-privilege authentication; keep credentials out of notebooks and repository files |
...
**Best checkpoint saved as:** `weeddet_best.pth` (in `weeddet_v4_checkpoints/`)<br>
...
| 6 | GitHub authentication rejected | All | Authentication failure in Colab | Historical auth configuration | Use current least-privilege authentication and keep credentials out of notebooks/repository files | LOW |
...
- Historical private Drive artifact; ID intentionally omitted from the public repository
- Used in: v3, v4, v5
...
The historical public document previously included exact Drive IDs, including locators for
unrelated personal files. Those values were removed during repository recovery. See the sanitized
`drive_links/GOOGLE_DRIVE_INVENTORY.md` and `docs/ARTIFACT_INVENTORY.md` for logical artifact names,
hash requirements, and publication policy.

---

## 17. GitHub Repository Structure

**URL:** https://github.com/Bmerrysmith/Autonomous-tractor-system<br>
**Branch:** master<br>
**Language:** Python 76%, Jupyter Notebook 24%<br>
**Commits:** 7 total<br>
**Open PRs:** 1

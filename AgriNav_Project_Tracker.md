...
**Institution:** U.A. Whitaker College of Engineering, Florida Gulf Coast University  
**GitHub:** `github.com/Bmerrysmith/Autonomous-tractor-system` (private, master branch)  
...
**Inverted spray approach:** the model detects rice as the *protected* class. Anything outside high-confidence rice detections is treated as a spray target. A hard rice-veto rule in the discrimination module prevents herbicide actuation on detected rice.

> The safety-asymmetric design (false negatives on rice → crop damage) is the paper's central novel contribution framing.
...
| GitHub access in Colab | Fine-grained tokens don't work | Use classic personal access tokens stored in Colab Secrets |
...
Target roles: computer vision, perception, or ML engineer.  
Target companies: Waymo, Aurora, NVIDIA, Bosch, Continental, Aptiv, defense contractors.  

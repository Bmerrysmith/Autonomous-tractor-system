...
**Status:** Superseded. Best checkpoint still valid for reference.<br>
...
## Drive Checkpoints
- `weeddet_v3_best.pth` (private Drive artifact; ID intentionally omitted)
- `weeddet_v3_epoch94.pth` (private Drive artifact; ID intentionally omitted)

## Other Files Created
- `rice_detection_demo.mp4` — private Drive demo artifact; ID intentionally omitted
